...
We are trying to construct the epipolar plane images correspondent to the sequence of different views of the church; for that we will follow the method that Bolles proposed in \cite{Bolles}. Due the straight linear trajectory of the camera, the points will follow an straight line trajectory that will stay in the corresponding epipolar line. The epipolar line will be parallel to the $x$-axis; we will use strongly this result.
