...
$$
\mathcal{SH}(\phi,\psi,\tilde{\psi},c):=\mathcal{P}_{\mathcal{R}}\Phi(\phi,c_1)\cup \mathcal{P}_{\mathcal{C}_h}\Psi(\psi,c)\cup\mathcal{P}_{\mathcal{C}_v}\tilde{\Psi}(\tilde{\psi},c)
$$
...
and $P_{\mathcal{R}}$, $\mathcal{P}_{\mathcal{C}_h}$ and $\mathcal{P}_{\mathcal{C}_v}$ are the projections in the Fourier domain.
\end{defn}
