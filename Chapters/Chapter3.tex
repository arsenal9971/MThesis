...
One would like to recover the lost sections of the EPIs

Before explaining the particular case of inpainting that we are working with it is worthwhile to present a general abstract framework of inpainting to grow some intuition behind this typical techinique on image processing. For this we need a separable Hilbert space $\mathcal{H}$, let $x^0$
